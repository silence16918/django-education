...
class TeacherListView(View):
    ...
    def get(self, request):
        ...
        search_keywords = request.GET.get('keywords', "")
        if search_keywords:
            all_teachers = all_teachers.filter(Q(name__icontains=search_keywords)|Q(work_campany__icontains=search_keywords)|Q(work_position__icontains=search_keywords))
